...
export const ReportNoteModal: React.FC<ReportNoteModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white border border-[#d1d5dc] rounded-2xl max-w-md w-full p-5 sm:p-6 relative shadow-2xl animate-in zoom-in-95 duration-150 text-neutral-900"
